...
Agents, LLMs, skills, tools, and links等一切智能体和执行器，都是可替代的、可插拔的、可调用的、可组合的、可进化的、可分享的
不应以LLM为中心-如ChatGPT，
也不应以平台为中心-如Manus，
智能革命+超级个体：一切以context为中心！Personal Data是当下的你的context的最小闭包，能产生最match的智能！
如果context是你的，才会以你为中心；如果context不是你的，不可能以你为中心；
